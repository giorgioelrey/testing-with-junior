...
use App\Page;
class UpdateVendemmiaHomeTextCarousel extends Seeder
{
    /**
    ...
    public function run()
    {
      ...
      $TextImageEnnewFieldVendemmia =[

        'carousel_image_text_en_1' => [
            'type' => 'string',
            'translated' => false,
            'data' => 'testo inglese',
        ],
    ...
    $pageHome->contents = json_encode(array_merge((array)json_decode($pageHome->contents),$TextImageEnnewFieldHome));
