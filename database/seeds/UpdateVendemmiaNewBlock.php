...
use App\Page;
class UpdateVendemmiaNewBlock extends Seeder
{
    /**
    ...
    public function run()
    {
      ...
      $blocknewFieldVendemmia =[
        ...
        $pageVendemmia->contents = json_encode(array_merge((array)json_decode($pageVendemmia->contents),$blocknewFieldVendemmia));
        ...
        $pageVendemmia->be_form_layout = json_encode([
            'sections' => [
                ...
                '2' => [
                    ...
                    'fields' => ['carousel_image_1', 'carousel_image_1_text','carousel_image_1_link__it','carousel_image_text_en_1','carousel_image_1_link__en']
                ],
                '3' => [
                    'title' => 'Carousel Image 2',
                    'fields' => ['carousel_image_2', 'carousel_image_2_text','carousel_image_2_link__it','carousel_image_text_en_2','carousel_image_2_link__en']
                ],
                '4' => [
                    'title' => 'Carousel Image 3',
                    'fields' => ['carousel_image_3', 'carousel_image_3_text','carousel_image_3_link__it','carousel_image_text_en_3','carousel_image_3_link__en']
                ],
                '5' => [
                    'title' => 'Riga 1',
                ...
                '13' => [
                    'title' => 'Riga 9',
                    'fields' => ['image_riga_9_url', 'titolo_riga_9__it', 'titolo_riga_9__en','content_riga_9__it','content_riga_9__en']
                ],
                '14' => [
                    'title' => 'Riga 10',
                    'fields' => ['image_riga_10_url', 'titolo_riga_10__it', 'titolo_riga_10__en','content_riga_10__it','content_riga_10__en']
                ],
