                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption  d-flex h-100 align-items-center justify-content-center">
                                    <a href="{{$lang == 'it' ? $contents->carousel_image_2_link->data->it : $contents->carousel_image_1_link->data->en}}"><h5>{{$contents->carousel_image_2_text->data}}</h5></a>
                                </div>
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption  d-flex h-100 align-items-center justify-content-center">
                                    ...
                                    <a href="{{$lang == 'it' ? $contents->carousel_image_1_link->data->it : $contents->carousel_image_1_link->data->en}}"><h5>{{$contents->carousel_image_3_text->data}}</h5></a>
                                </div>
