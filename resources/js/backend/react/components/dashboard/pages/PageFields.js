    ...
    { Object
         ...
         .map((field, idx) => {
          ...
          switch (field.type) {
            ...
            case 'image': console.log('field image ', field.name); return (<FileUploadInputFormikField key={idx} setFieldValue={setFieldValue} label={field.name} name={field.name} values={values} errors={errors} touched={touched} currentImage={field.previousUrl}/>); break;
